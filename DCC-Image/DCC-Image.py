# Scrip made by https://github.com/Twentysix26/Red-DiscordBot
# Edited to serve the purpose to DCC
...
class DCC_Image:
    ...
    async def gif(self, ctx, *keywords):
        ...
        shitposting = discord.utils.get(
            server.channels, name='shitposting', type=discord.ChannelType.text)
        bot_coders = discord.utils.get(
        ...
        if channel is shitposting or bot_coders or management:
            if keywords:
            ...
            url = ("http://api.giphy.com/v1/gifs/search?&api_key={}&q={}""".format(GIPHY_API_KEY, keywords))
